...
<nav class="bg-white shadow-sm dark:bg-slate-800">
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="flex justify-center h-12 space-x-4">
            ...
            <a href="{{ route('rencana.index') }}" class="{{ request()->routeIs('rencana.*') ? 'border-blue-500 text-gray-900 dark:text-white' : 'border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200' }} inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
                Rencana
            </a>
            <a href="{{ route('grup.index') }}" class="{{ request()->routeIs('grup.*') ? 'border-blue-500 text-gray-900 dark:text-white' : 'border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200' }} inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
                Grup
            </a>
        </div>
    </div>
