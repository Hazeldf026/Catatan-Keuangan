                ...
                <div class="bg-white dark:bg-slate-800 rounded-xl shadow-lg p-8">
                    <div class="text-center">
                        ...
                        <p class="mt-2 text-gray-500 dark:text-gray-400">
                            We've sent a verification code to your email<br><strong>{{ session('email', 'your email') }}</strong>
                        </p>
                    </div>
                    
                    <form x-ref="otpForm" x-data="otpForm()" class="mt-8" action="{{ route('otp.verify') }}" method="POST">
                        @csrf
