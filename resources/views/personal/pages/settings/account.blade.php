    ...
    <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
        ...
        <div x-data="{
            ...
            <form action="{{ route('settings.account.update') }}" method="POST" class="space-y-6">
                ...
                {{-- Bagian Email & OTP (sudah benar dari sebelumnya) --}}
                    ...
                    <div class="space-y-4">
                         <div>
                            ...
                            <input type="email" id="email" name="email_current" value="{{ $user->email }}" disabled
                                   class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm bg-gray-100 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-400 sm:text-sm cursor-not-allowed">
                        ...
                        <div>
                            <button type="button" @click="
                                ...
                                fetch('{{ route('settings.account.send_otp') }}', { /* ... fetch logic ... */
                                    method: 'POST',
                ...
                <fieldset class="border dark:border-gray-700 p-4 rounded-md">
                     ...
                     <div class="space-y-4">
                        <div>
                            ...
                            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Minimal 8 karakter, kombinasi huruf besar, kecil, angka, dan simbol.</p>
